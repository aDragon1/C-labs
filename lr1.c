...
int main(void)
{
    ...
    // Task2:
    float r1, r2, r3;
    printf("Enter r1 r2 r3 for task 2: \n");
    printf("r1 =");
    scanf("%f", &r1);
    printf("r2 =");
    scanf("%f", &r2);
    ...
    // Task3:
    float num;
    printf("Enter number for task 3:\n");
    printf("Number is - ");
    scanf("%f", &num);
    printf("Sum of the squares of the digits of a number  = %d", task3(num));
